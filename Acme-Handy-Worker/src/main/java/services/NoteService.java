...
public class NoteService {
	...
	public Note save(final Note note) {
		...
		Assert.isTrue(this.customerService.findByPrincipal() == note.getCustomer() || this.refereeService.findByPrincipal() == note.getReferee() || this.handyWorkerService.findByPrincipal() == note.getHandyWorker());
